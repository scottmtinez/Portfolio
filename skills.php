<?php 
    ...
    echo "<script src='skills.js'></script>";
        ...
        <!-- C++ -->
            <div class='sbox' id='s1'>
                ...
                <p>
                    ...
                    Additionally, we focused on effective planning and testing techniques to ensure robust code. 
                    Furthermore, we tackled the optimization of array sorting using various algorithms.<br><br>

                    <h6 style='color: purple;'>Projects Worked On:</h6>
                    Sorting Arrays & Lists using Insertion Sort, Bubble Sort, Radix Sort, Merge Sort, Quick Sort, & Heap Sort. <br>
                    Traversing through binary trees using DFS, BFS, & DAG. <br>
                    Built a Tic Tac Toe computer game that the user would play against an AI system. <br><br>

                    <h6 style='color: purple;'>Courses Taken:</h6>
                    Intro & Intermediate C++ <br>
                    Data Structures <br>
        ...
        <!-- Java -->
            <div class='sbox' id='s2'>
                ...
                <p>
                    ...
                    Taught how to use multi-dimensional arrays, methods, error handling, strings, regular expressions, encapsulation, inheritance, polymorphism, generic types, program debugging and testing, database and file processing, event-handling, and graphical user interfaces.<br><br>

                    <h6 style='color: purple;'>Projects Worked On:</h6>
                    Using an array to print out a list of the best figure skaters from each state. <br><br>

                    <h6 style='color: purple;'>Courses Taken:</h6>
                    Intro & Intermediate Java <br>
                </p>
            </div>
        ...
        <!-- HTML -->
            <div class='sbox' id='s3'>
                ...
                <p>
                    ...
                    Using HTML forms to update, delete, and create new information into the database. <br><br>

                    <h6 style='color: purple;'>Projects Worked On:</h6>
                    Personal front-end portfolio Web Application <br>
                    Group Project Recipe Web Application <br>
                    Workout Routine Creator Web Application <br>
                    Weather Widget that uses an API <br>
                    Digital Clock Web Application <br><br>

                    <h6 style='color: purple;'>Courses Taken:</h6>
                    JavaScript & DHTML <br>
                    Database Management Systems <br>
                    Server-Side Scripting <br>
                    Program Language Concepts <br>
                    Web Server & UNIX Admin <br>
        ...
        <!-- CSS -->
            <div class='sbox' id='s4'>
                ...
                <p>
                    ...
                    Modern like Web Application. <br>
        ...
        <!-- Linux -->
            <div class='sbox' id='s6'>
                ...
                <p>
                    ...
                    Shell Programming Skills. <br><br>

                    <h6 style='color: purple;'>Projects Worked On:</h6>
                    Adding programming projects to a file using Linux. <br>
                    Running FIN_Scan and running the scan with Linux. <br>
                    Checking to see if files have been updated by another computer without access. <br><br>
        ...
        <!-- Databases-->
            <div class='sbox' id='s7'>
                ...
                <p>
                    ...
                    Personal front-end portfolio Web Application <br>
                    Group Project Recipe Web Application <br>
                    Workout Routine Creator Web Application <br><br>

                    <h6 style='color: purple;'>Courses Taken:</h6>
                    Advanced Web App Development <br>
                    Web Server & UNIX Admin <br>
                    Software Engineering <br>
        ...
        <!-- Swift -->
            <div class='sbox' id='s10'>
                ...
                <p>
                    ...
                    <h6 style='color: purple;'>Projects Worked On:</h6>
                    Temple Run like ios appication <br><br>
        ...
        <!-- Adobe Photoshop-->
            <div class='sbox' id='s11'>
                ...
                <p>
                    ...
                    <h6 style='color: purple;'>Projects Worked On:</h6>
                    Editing Pictures <br>
                    Social Media Profile Pictures <br><br>
        ...
        <!-- Adobe Illustrator -->
            <div class='sbox' id='s12'>
                ...
                <p>
                    ...
                    <h6 style='color: purple;'>Projects Worked On:</h6>
                    Business Logos <br>
                    Creating designs to print out on products <br><br>
